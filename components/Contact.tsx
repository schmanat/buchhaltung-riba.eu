        ...
        <Card className="p-0">
          <CardContent className="p-0">
            <div className="grid md:grid-cols-2">
              ...
              {/* CTA Area */}
              <div className="bg-primary p-6 lg:p-8 flex flex-col justify-center items-center text-center text-primary-foreground rounded-b-xl md:rounded-bl-none md:rounded-r-xl">
